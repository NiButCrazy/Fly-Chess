...
export class WarnDialogBox {
    constructor(message = '这是一个警告框', title = '警告', icon = warn_dialog_box_default_svg, buttons = [ '取消', '确定' ]) {
        ...
        warn_dialog_box__message.innerText = message
        ...
        document.body.appendChild(warn_dialog_box)
    }
    close(){
...
export class InputDialogBox {
    constructor(message = '这是输入说明', title = '输入框标题', buttons = [ '确定', '提交' ], options = { type: 'text', placeholder: '请输入', value: '' }) {
        ...
        input_dialog_box__content.innerText = message
        ...
        document.body.appendChild(input_dialog_box)
    }
    close(){
        this.Element.classList.add('dialog-close')
        setTimeout(()=>{this.Element.remove()},200)
...
export class PromptDialogBox {
    constructor(message = '这是一个提示框', title = '提示', icon = prompt_dialog_box_default_svg, buttons = [ '确定' ]) {
...
export class ConfirmDialogBox {
    constructor(message = '这是一个确认框', title = '确认吗', icon = confirm_dialog_box_default_svg, buttons = [ '取消', '确定' ]) {
